...
@Component
public class GetNewCommentsUseCase {

  private final CommentRepository commentRepository;
  private final CommentMapper commentMapper;

  public GetNewCommentsUseCase(CommentRepository commentRepository, CommentMapper commentMapper) {
    this.commentRepository = commentRepository;
    this.commentMapper = commentMapper;
  }

  public List<CommentResponse> execute (int limit) {
    return commentRepository.findNewComments(limit).stream()
