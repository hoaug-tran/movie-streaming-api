...
public class GetRepliesUseCase {
  ...
  public GetRepliesUseCase(CommentRepository commentRepository, CommentMapper commentMapper) {
    this.commentRepository = commentRepository;
    this.commentMapper = commentMapper;
  }

  public List<CommentResponse> execute (Long parentCommentId) {
    return commentRepository.findVisibleRepliesByParentCommentIdOrderByCreatedAtAsc(parentCommentId)
