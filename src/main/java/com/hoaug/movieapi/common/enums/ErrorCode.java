...
public enum ErrorCode {
  ...
  CATEGORY_EXISTED(409, "Thể loại này đã tồn tại. Vui lòng chọn tên hoặc slug khác."),
  TAG_NOT_FOUND(404, "Không tìm thấy thẻ phim này"),
  TAG_EXISTED(409, "Tag này đã tồn tại. Vui lòng chọn tên hoặc slug khác."),
  PERSON_NOT_FOUND(404, "Không tìm thấy người này"),
  PERSON_EXISTED(409, "Diễn viên/Đạo diễn này đã tồn tại."),
  STUDIO_NOT_FOUND(404, "Không tìm thấy hãng sản xuất này"),
  STUDIO_EXISTED(409, "Studio/Nhà sản xuất này đã tồn tại. Vui lòng chọn tên hoặc slug khác."),
  ...
  REVIEW_CONTENT_TOO_SHORT(400, "Nội dung đánh giá phải có ít nhất 10 ký tự"),
  REVIEW_CONTENT_SPAM(400, "Nội dung đánh giá có dấu hiệu spam (ký tự lặp lại quá nhiều)"),
  REVIEW_RATING_INVALID(400, "Số sao đánh giá phải nằm trong khoảng 1 đến 5"),
